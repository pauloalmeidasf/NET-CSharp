...
namespace Projeto01_SalvarArquivos.Class
{
    internal class Clima
    {
        ...
        //IEnumerable: Interface indicada para consultar dados de coleções como List<T> e Array
        ...
        public static void SalvarJson(string arquivoJson, List<Clima> dados)
        {
            ...
            string jsongString = JsonSerializer.Serialize(dados);

            File.AppendAllText(arquivoJson, jsongString);
